 ...
 */
public class AppendFileHandler implements ParserHandler<StorageClientInfo, ByteBuffer> {
    ...
    public void handleEnd(StorageClientInfo con, ByteBuffer nioData) {
        ...
        String s = new String(bytes);
        con.fileContext.filenameBuffer.append(s);
        con.fileContext.filename = con.fileContext.filenameBuffer.toString();
        con.fileContext.filenameBuffer = null;
