...
import io.mybear.common.storage.StorageDioThreadData;
import io.mybear.common.trunk.FdfsStorePaths;
...
import static io.mybear.common.trunk.TrunkShared.FDFS_TRUNK_FILE_ALLOC_SIZE_OFFSET;
import static io.mybear.common.trunk.TrunkShared.FDFS_TRUNK_FILE_TYPE_REGULAR;
    ...
    public static int dio_write_file(StorageClientInfo pTask) {
        ...
        try {
            ...
            if (channel == null || !channel.isOpen()) {
                ThrowingConsumer<StorageClientInfo> callback = uploadInfo.beforeOpenCallback;
                if (callback != null) {
    ...
    public int dio_truncate_file(StorageClientInfo pTask) {
        ...
        try {
            if (pFileContext.fileChannel == null || !pFileContext.fileChannel.isOpen()) {
                ...
                if (uploadInfo.beforeCloseCallback != null) {
                    uploadInfo.beforeCloseCallback.accept(pTask);
                }
                pFileContext.fileChannel.close();
                pFileContext.fileChannel = null;
                if (pFileContext.done_callback == null) {
